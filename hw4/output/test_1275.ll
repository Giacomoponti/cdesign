...
@_s12201 = global i8* bitcast ([4 x i8]* @_s2200 to i8*)
@_s2203 = global [4 x i8] c"def\00"
@_s12204 = global i8* bitcast ([4 x i8]* @_s2203 to i8*)
@_s2212 = global [4 x i8] c"789\00"
@_s12213 = global i8* bitcast ([4 x i8]* @_s2212 to i8*)
@_s2215 = global [4 x i8] c"123\00"
@_s12216 = global i8* bitcast ([4 x i8]* @_s2215 to i8*)
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_tmp2202 = load i8*, i8** @_s12201
  %_tmp2205 = load i8*, i8** @_s12204
  ...
  store i8* %_tmp2202, i8** %_gep2208
  %_gep2210 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array2207, i32 0, i32 1, i32 1
  store i8* %_tmp2205, i8** %_gep2210
  %_tmp2214 = load i8*, i8** @_s12213
  %_tmp2217 = load i8*, i8** @_s12216
  ...
  store { i64, [0 x i8*] }* %_array2207, { i64, [0 x i8*] }** %_gep2226
  %_gep2228 = getelementptr { i64, [0 x { i64, [0 x i8*] }*] }, { i64, [0 x { i64, [0 x i8*] }*] }* %_array2225, i32 0, i32 1, i32 1
  store { i64, [0 x i8*] }* %_array2219, { i64, [0 x i8*] }** %_gep2228
