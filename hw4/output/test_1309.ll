...
@_s16025 = global i8* bitcast ([1 x i8]* @_s6024 to i8*)
@_s5989 = global [7 x i8] c"TOMATO\00"
@_s15990 = global i8* bitcast ([7 x i8]* @_s5989 to i8*)
@_s5994 = global [8 x i8] c"ORATING\00"
@_s15995 = global i8* bitcast ([8 x i8]* @_s5994 to i8*)
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_tmp5991 = load i8*, i8** @_s15990
  store i8* %_tmp5991, i8** %_tomato5992
  %_tmp5996 = load i8*, i8** @_s15995
