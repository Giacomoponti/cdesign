...
@_s2177 = global i8* bitcast ([4 x i8]* @_s2176 to i8*)
@_s2179 = global [4 x i8] c"def\00"
@_s2180 = global i8* bitcast ([4 x i8]* @_s2179 to i8*)
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_tmp2178 = load i8*, i8** @_s2177
  %_tmp2181 = load i8*, i8** @_s2180
