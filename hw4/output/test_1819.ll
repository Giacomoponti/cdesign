...
@_s5408 = global i8* bitcast ([2 x i8]* @_s5407 to i8*)
@_s5404 = global [2 x i8] c"F\00"
@_s5405 = global i8* bitcast ([2 x i8]* @_s5404 to i8*)
@_s5365 = global [2 x i8] c" \00"
@_s5366 = global i8* bitcast ([2 x i8]* @_s5365 to i8*)
...
_if5402:
  %_tmp5409 = load i8*, i8** @_s5408
  ret i8* %_tmp5409
_else5401:
  %_tmp5406 = load i8*, i8** @_s5405
  ret i8* %_tmp5406
}
