...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 17, i64* %_gep1326
  %_gep1328 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array1325, i32 0, i32 1, i32 1
  store i64 42, i64* %_gep1328
  store { i64, [0 x i64] }* %_array1325, { i64, [0 x i64] }** @arr
  %_arr1333 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr
  %_ptr1331 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_arr1333, i32 0, i32 1, i32 1
  %_resPtr1332 = load i64, i64* %_ptr1331
  ret i64 %_resPtr1332
}
